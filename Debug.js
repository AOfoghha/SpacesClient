...
const FunctionalComponent = () => {
  ...
  const hasSystemFeature = useHasSystemFeature('com.google.android.gms');
  ...
  return (
    <ScrollView>
      <Text
        onPress={Clipboard.setString(`${JSON.stringify(deviceJSON, null, '  ')}`)}
      ...
      <SafeAreaView style={styles.container}>
        ...
        {this.state.activeTab === 'constant' ? (
          <>
            <ScrollView>
              <Text
                onPress={Clipboard.setString(`${JSON.stringify(this.state.constantdeviceinfo, null, '  ')}`)}
                style={styles.instructions}>
          ...
          <>
            <ScrollView>
              <Text
                onPress={Clipboard.setString(`${JSON.stringify(this.state.syncdeviceinfo, null, '  ')}`)}
                style={styles.instructions}>
          ...
          <>
            <ScrollView>
              <Text
                onPress={Clipboard.setString(`${JSON.stringify(this.state.asyncdeviceinfo, null, '  ')}`)}
                style={styles.instructions}>
